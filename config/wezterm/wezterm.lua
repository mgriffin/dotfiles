...
--- https://microblog.desipenguin.com/post/accent-marks-wezterm/
--- https://github.com/wez/wezterm/issues/2920#issuecomment-1371466131
...
config.keys = {
	...
	{
    -- I'm used to tmux bindings, so am using the slash (\) key to
    -- split horizontally, and the dash (-) key to split vertically.
    key = '\\',
